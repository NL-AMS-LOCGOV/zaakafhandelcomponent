...
public enum Mail {
    ...
    PROCES_AANVULLENDE_INFORMATIE(MailTemplateVariabelen.PROCES_VARIABELEN),
    PROCES_ONTVANGSTBEVESTIGING(MailTemplateVariabelen.PROCES_VARIABELEN),
    PROCES_ADVIES(MailTemplateVariabelen.PROCES_VARIABELEN),

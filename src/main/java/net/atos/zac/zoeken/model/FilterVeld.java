...
public enum FilterVeld {
    ...
    public static final Set<FilterVeld> ZAAK_FACETTEN = Collections.unmodifiableSet(
            EnumSet.of(ZAAKTYPE, ZAAK_STATUS, BEHANDELAAR, GROEP, ZAAK_RESULTAAT));

    public static final Set<FilterVeld> DOCUMENT_FACETTEN = Collections.unmodifiableSet(
            EnumSet.of(DOCUMENT_STATUS, DOCUMENT_TYPE, DOCUMENT_VERGRENDELD_DOOR, ZAAKTYPE));
    ...
    public static final Set<FilterVeld> FACETTEN = Collections.unmodifiableSet(
            EnumSet.of(TYPE, ZAAKTYPE, TOEGEKEND, BEHANDELAAR, GROEP, ZAAK_STATUS, ZAAK_RESULTAAT, TAAK_NAAM,
                       TAAK_STATUS, DOCUMENT_STATUS, DOCUMENT_TYPE, DOCUMENT_VERGRENDELD_DOOR));

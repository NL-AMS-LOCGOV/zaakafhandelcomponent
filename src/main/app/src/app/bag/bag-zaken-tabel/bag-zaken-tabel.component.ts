...
export class BagZakenTabelComponent implements OnInit, AfterViewInit, OnChanges {
    ...
    columns: string[] = ['identificatie', 'status', 'groep', 'behandelaar', 'startdatum', 'zaaktype', 'omschrijving', 'url'];

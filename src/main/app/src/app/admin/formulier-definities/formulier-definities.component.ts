...
export class FormulierDefinitiesComponent extends AdminComponent implements OnInit {

    @ViewChild('sideNavContainer') sideNavContainer: MatSidenavContainer;
    @ViewChild('menuSidenav') menuSidenav: MatSidenav;

    isLoadingResults: boolean = false;
    columns: string[] = ['systeemnaam', 'naam', 'beschrijving', 'creatiedatum', 'wijzigingsdatum', 'aantal', 'id'];
    dataSource: MatTableDataSource<FormulierDefinitie> = new MatTableDataSource<FormulierDefinitie>();

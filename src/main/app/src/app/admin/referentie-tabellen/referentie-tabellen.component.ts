...
export class ReferentieTabellenComponent extends AdminComponent implements OnInit {
    ...
    verwijderReferentieTabel(referentieTabel: ReferentieTabel): void {
        this.dialog.open(ConfirmDialogComponent, {
            ...
            if (result) {
                this.utilService.openSnackbar('msg.tabel.verwijderen.uitgevoerd', {tabel: referentieTabel.code});
                this.laadReferentieTabellen();
            }
        });
    }

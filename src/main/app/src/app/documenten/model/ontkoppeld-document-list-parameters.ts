...
export class OntkoppeldDocumentListParameters extends ListParameters implements ZoekFilters {
    ...
    static heeftActieveFilters(zoekFilters: any): boolean {
        ...
        if (zoekFilters.ontkoppeldOp?.van != null || zoekFilters.ontkoppeldOp?.tot != null) {
            return true;
        }
        if (zoekFilters.creatiedatum?.van != null || zoekFilters.creatiedatum?.tot != null) {
            return true;
        }

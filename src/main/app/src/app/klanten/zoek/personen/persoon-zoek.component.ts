...
export class PersoonZoekComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.geboortedatumFormField = new DateFormFieldBuilder()
                ...
                .label('geboortedatum')
                .build();
        const gemeenteIcon: ActionIcon = new ActionIcon('location_city', 'gemeenteMijn', new Subject<void>());
        ...
        this.formGroup = this.formBuilder.group({
            ...
            gemeenteVanInschrijving: this.gemeenteVanInschrijvingFormField.formControl,
    ...
    isValid(): boolean {
        const parameters: ListPersonenParameters = this.createListPersonenParameters();
        this.updateControls(this.getValidQueries(parameters, false));
        return this.formGroup.valid && 0 < this.getValidQueries(parameters, true).length;
    }

    private getValidQueries(values: ListPersonenParameters, compleet: boolean): PersonenParameters[] {

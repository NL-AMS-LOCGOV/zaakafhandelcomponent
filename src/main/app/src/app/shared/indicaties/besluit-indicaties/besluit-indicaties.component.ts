...
export class BesluitIndicatiesComponent extends IndicatiesComponent implements OnChanges {
    ...
    private getIntrekToelichting(): string {
        return this.translate.instant('besluit.vervalreden.' + this.besluit.vervalreden);
    }
}

...
import {MailtemplateVariabele, MailtemplateVariabeleUtil} from '../../../../admin/model/mailtemplate-variabele';
...
export class HtmlEditorFormField extends AbstractFormControlField {
    ...
    variabelen: MailtemplateVariabele[] = MailtemplateVariabeleUtil.getDefaultVariabelen();

...
export class AutocompleteComponent extends FormComponent implements AfterViewInit, OnDestroy {
    ...
    initOptions() {
        this.data.formControl.setAsyncValidators(AutocompleteValidators.asyncOptionInList(this.data.options));

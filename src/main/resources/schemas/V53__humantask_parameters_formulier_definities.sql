...
ALTER TABLE ${schema}.humantask_parameters
    ADD COLUMN id_behandel_formulier_definition VARCHAR;
...
CREATE INDEX idx_humantask_parameters_id_behandel_formulier_definition
    ON ${schema}.humantask_parameters USING btree (id_behandel_formulier_definition);

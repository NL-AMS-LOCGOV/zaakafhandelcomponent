...
export WILDFLY_VERSION=26.0.0.Final
export WILDFLY_SERVER_DIR=wildfly-$WILDFLY_VERSION

echo ">>> Installing WildFly ..."
rm -fr $WILDFLY_SERVER_DIR
galleon.sh install wildfly#$WILDFLY_VERSION --dir=$WILDFLY_SERVER_DIR --layers=jaxrs-server,microprofile-health,elytron-oidc-client
